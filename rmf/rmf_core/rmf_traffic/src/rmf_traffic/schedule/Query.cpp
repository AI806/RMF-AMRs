...
public:
    ...
    rmf_utils::optional<Time> upper_bound)
  {
    ...
    span._pimpl = rmf_utils::make_impl<Implementation>(
      Implementation{  //这种语法，猜测是对maps, all_maps， lower_bound和upper_bound 分别进行初始化
...
//==============================================================================
auto Query::Spacetime::query_regions(std::vector<Region> regions) -> Regions& // 指定返回类型是 Region&
{
